                    ...
                    >
                      ...
                      <div className={`${styles.contenidoMascota}`}>
                        ...
                        <h2
                          className={`${
                            styles.textoOscuro
                          } px-3 uppercase font-bold  ${
                            acordeonAbierto[
                              idUnico as keyof typeof acordeonAbierto
                            ]
                              ? " text-center"
                              : "text-start"
                          }`}
                        ...
                        >
                          <div className="mb-2">
                            <h3 className={`${styles.categoryOscuro}`}>
                              Especie{" "}
                            </h3>
                            <h4 className={`${styles.resultsData}`}>
                              {" "}
                              {especie}{" "}
                            </h4>
                          </div>
                      ...
                      <div className={`${styles.contenedorCfg}`}>
                        ...
                        <Image
                          ...
                          onClick={() =>
                            idUnico !== undefined &&
                            handleOption(idUnico, deleteCard)
                          }
                        ></Image>
                      </div>
                        ...
                        <>
                          <div className="flex items-center flex-col w-full  ">
                            ...
                            <div className={`${styles.contenedorMascota} `}>
                              <h3 className={`${styles.titularLabel} `}>
                                Salud
                              </h3>

                              <div className="pl-20">
                                <h4 className={`${styles.titleData}`}>
                                  Esterilizado
                                </h4>
                                <h5> {esterilizado} </h5>
                              </div>
